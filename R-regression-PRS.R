...
write.table(t(c("Thres.score" ,"Estimate", "Std.Error",   "t-value",   "P","adj.r.squared","BETA" )), file=outfile, row.names=F,  col.names=F,quote=F, sep="\t", append=T)####linear regression  
